...
impl BaselineUpdater {
    ...
    pub fn update_rates(baseline: &mut HostBaseline, event: &Event, metric_name: &str, rate: f64) {
        ...
        let rate_baseline = baseline.rate_baselines
    ...
    pub fn update_feature_vector(
        ...
        let fv_baseline = baseline.feature_vector_baselines
...
mod tests {
    ...
    fn test_extract_prefix() {
        ...
        assert_eq!(BaselineUpdater::extract_prefix("/home/user/file.txt"), "/home/user");
    ...
    fn test_update_first_seen() {
        ...
        event.fields.insert("dest_ip".to_string(), serde_json::json!("192.168.1.1"));
        
        BaselineUpdater::update_first_seen(&mut baseline, &event);
        
        assert!(baseline.first_seen.remote_ips_per_exe
            .get("proc_123")
