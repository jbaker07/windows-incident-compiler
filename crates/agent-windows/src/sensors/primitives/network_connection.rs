...
pub fn detect_network_connection(base_event: &Event) -> Option<Event> {
    ...
    Some(Event {
        ...
        tags: vec!["windows".to_string(), "network_connection".to_string(), "sysmon".to_string()],
...
fn is_suspicious_port(port: u16) -> bool {
    matches!(port, 
        ...
        123 | 53 |  // NTP, DNS (timing channels)
